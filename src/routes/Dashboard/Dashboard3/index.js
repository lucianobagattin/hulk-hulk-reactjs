...
class Dashboard3 extends Component {
	...
	state = {
		columns: [
			...
			{ title: 'Product Image', field: 'productImage', render: rowData => <div className="img-50"> <img src={require(`assets/Images/${rowData.productImage}`)} alt="product-img" className="img-fluid" style={{ borderRadius: '2px' }} /></div> },
			{ title: 'Url', field: 'url' },
			{ title: 'No. Of Hits', field: 'noOfHits' },
