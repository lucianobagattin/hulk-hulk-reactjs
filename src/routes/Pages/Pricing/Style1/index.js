														...
														<Box>
															{this.state.monthlyPlan ?
																<Box mb={2} style={{ textAlign: 'center' }}>
																	<Typography variant="h3" style={{ marginBottom: '15px', textAlign: 'center' }} dangerouslySetInnerHTML={this.createMarkup(`${item.price[1]}`)}>
																	</Typography>
																...
																:
																<Box mb={2} style={{ textAlign: 'center' }}>
																	<Typography variant="h3" style={{ marginBottom: '15px', textAlign: 'center' }} dangerouslySetInnerHTML={this.createMarkup(`${item.price[0]}`)}></Typography>
...
export default (withStyles(styles)(Style1));